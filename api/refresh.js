...
export default async function handler(req, res) {
  ...
  try {
      ...
      // Pearson is still disabled - it goes through eCampus's LTI launch
      // and hasn't been updated to use the persistent session yet.
      pearsonData = { disabled: true, message: 'Temporarily disabled - not yet updated to use persistent session' };
